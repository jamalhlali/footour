...
describe('Service Tests', () => {
  describe('Organizer Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Organizer(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Organizer', async () => {
      ...
      it('should update a Organizer', async () => {
        const returnedFromService = Object.assign(
          {
            firstName: 'BBBBBB',
            lastName: 'BBBBBB',
      ...
      it('should return a list of Organizer', async () => {
        const returnedFromService = Object.assign(
          {
            firstName: 'BBBBBB',
            lastName: 'BBBBBB',
      ...
      it('should delete a Organizer', async () => {
