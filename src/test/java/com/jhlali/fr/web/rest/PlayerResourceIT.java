...
import com.jhlali.fr.domain.Player;
import com.jhlali.fr.repository.PlayerRepository;
...
public class PlayerResourceIT {
    ...
    private static final Long DEFAULT_YEAR_OF_BIRTH = 1L;
    private static final Long UPDATED_YEAR_OF_BIRTH = 2L;
    private static final Long SMALLER_YEAR_OF_BIRTH = 1L - 1L;
    ...
    public void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getYearOfBirth()).isEqualTo(DEFAULT_YEAR_OF_BIRTH);
    }
    ...
    public void getAllPlayers() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].yearOfBirth").value(hasItem(DEFAULT_YEAR_OF_BIRTH.intValue())));
    }
    ...
    public void getPlayer() throws Exception {
        ...
        restPlayerMockMvc.perform(get("/api/players/{id}", player.getId()))
            ...
            .andExpect(jsonPath("$.yearOfBirth").value(DEFAULT_YEAR_OF_BIRTH.intValue()));
    }
    ...
    public void updatePlayer() throws Exception {
        ...
        assertThat(testPlayer.getYearOfBirth()).isEqualTo(UPDATED_YEAR_OF_BIRTH);
    }
